...
public class CustomSiteMeshFilter extends ConfigurableSiteMeshFilter
{
    ...
    protected void applyCustomConfiguration(SiteMeshFilterBuilder builder)
    {
        ...
        builder.addDecoratorPath("/login", "web/login.jsp")
                .addDecoratorPath("/create-account", "web/register.jsp")
                .addDecoratorPath("/forgot-password", "web/register.jsp")
                .addDecoratorPath("/check-email", "web/register.jsp")
                .addDecoratorPath("/reset-password", "web/register.jsp")
